...
| ------------ | ---------------------------------------------------------------------------- |
| Status       | Active                                                                       |
| Last updated | 2026-05-29 (Phases B+C+D collapsed; renumbered to B1..B16)                   |
...
### A4. Site polish & shareability (FEAT-007)

| Field      | Value                                                                                                                                                                                                         |
| ---------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Status     | Approved — ready to build                                                                                                                                                                                     |
| Owner      | Site builder                                                                                                                                                                                                  |
| Spec       | [features/site-polish.md](features/site-polish.md)                                                                                                                                                            |
| Acceptance | Per FEAT-007 §4 — OG/Twitter Card meta on every route, JSON-LD `Person` on `/`, `sitemap.ts` + `robots.ts`, favicon set, custom 404, footer.                                                                  |
| Notes      | One spec covering six small additions because they all answer "what makes this URL feel finished when shared?" Adds two optional `Site` fields (`siteUrl`, `repoUrl`). Owner provides OG image + favicon art. |

### A5. Contact page (FEAT-008)
...
| Acceptance | Per FEAT-008 §4 — `/contact` with mailto + social links + optional booking link. PrimaryNav gains a 4th `Contact` pill.      |
| Notes      | Adds optional `Site.bookingUrl`. **Explicitly respects PRD §3 non-goal** "No contact form with email backend" — mailto only. |
